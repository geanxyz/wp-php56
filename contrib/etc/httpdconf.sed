...
s%^DocumentRoot "/opt/rh/httpd24/root/var/www/html"%DocumentRoot "/opt/app-root/html"%
s%^<Directory "/opt/rh/httpd24/root/var/www/html"%<Directory "/opt/app-root/html"%
s%^<Directory "/opt/rh/httpd24/root/var/html"%<Directory "/opt/app-root/html"%
